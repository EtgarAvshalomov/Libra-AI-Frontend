...
export default function ModelSelect({ models, selectedModelValue, setSelectedModelValue }: ModelSelectProps) {
    ...
    return (
        <div className="flex mt-[3px] ml-[2%] w-[30%]">
            ...
            <select 
                className="bg-transparent max-lg:text-[12px] appearance-none cursor-pointer text-[#cfcfcf] border-1 border-[grey] rounded-[6px] w-[10rem] pl-[6px] text-[14px] font-[inter] truncate focus:outline-none focus:bg-[#404045]" 
                id="model-select" 
