...
export default function Intro({ sidebarExpanded, isDesktop }: IntroProps) {
    ...
    return (
        <div className={`mt-[18.35%] lg:transition-[margin-left] lg:duration-300 lg:ease-in-out max-sm:ml-[16%] sm:ml-[30%] mr-[50px] md:ml-[35%] ${sidebarExpanded ? 'lg:ml-[49%]' : 'lg:ml-[42%]'}`}>
