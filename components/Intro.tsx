...
export default function Intro({ sidebarExpanded, isDesktop }: IntroProps) {
    ...
    return (
        <div className={`mt-[18.35%] lg:transition-[margin-left] lg:duration-300 lg:ease-in-out max-sm:ml-[13%] sm:ml-[30%] mr-[50px] md:ml-[35%] ${sidebarExpanded ? 'lg:ml-[49%]' : 'lg:ml-[42%]'}`}>
          <div className={`transition-[opacity] duration-300 ease-in-out`}>
              ...
              <p className="max-sm:text-[14px] text-[#ffffff] text-center max-sm:px-[12px]">Start a new chat or select an existing one</p>
          </div>
      </div>
    )
}