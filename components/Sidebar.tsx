...
export default function Sidebar({ chatIdParam, sidebarExpanded, setSidebarExpanded, isLoggedIn, setIsLoggedIn }: SidebarProps) {

    const [profileMenu, setProfileMenu] = useState(false);

    return (
        <aside className={`fixed flex flex-col bg-[#212327] h-[98.4%] rounded-[12px] transition-[width] duration-300 ease-in-out ${sidebarExpanded ? 'w-[280px] text-center' : 'w-[68px]'}`}>
