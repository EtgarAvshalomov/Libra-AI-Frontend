...
export default function Chat({ params }: { params: Promise<{ chatIdParam: string }> }) {
  ...
  return (
    <>
      ...
      <div className={`container text-center lg:mt-[14.6%] md:mt-[30%] sm:mt-[35%] max-sm:mt-[45%] transition-[all] duration-300 ease-in-out lg:ml-[210px] md:ml-[10%] sm:ml-[10%] max-sm:ml-[0px] ${sidebarExpanded && 'xl:ml-[310px]'}`}>
